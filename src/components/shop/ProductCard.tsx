...
export default function ProductCard({ id, name, capacity, color, price, image, grade, stock }: ProductCardProps) {
  return (
    <Link
      to={`/store/${id}`}
    ...
    >
      ...
      <div className="p-6">
        ...
        <button className="mt-6 w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-xl font-bold text-lg shadow-lg hover:from-blue-700 hover:to-blue-800 transition-all">
          Zobraziť detail
        </button>
      </div>
    </Link>
